...
const certifications = [
  { name: "Anthropic - Prompt Engineering and AI Safety", issuerLogo: "Anthropic", link: "/Anthropic - Certificate.png" },
                  ...
                  <span className="text-muted-foreground text-sm"> - {' '}
                    {cert.link ? (
                      <Link
                        ...
                        className="inline-block font-medium underline text-[hsl(var(--highlight-yellow))] hover:scale-105 transition-all duration-200 ease-in-out"
                      >
                        {cert.issuerLogo}
                      </Link>
                    ) : (
